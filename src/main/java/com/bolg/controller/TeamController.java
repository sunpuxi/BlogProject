...
import com.bolg.model.dto.team.*;
import com.bolg.model.entity.Team;
import com.bolg.model.entity.UserTeam;
import com.bolg.annotation.Limit;
import com.bolg.model.DeleteRequest;
import com.bolg.model.entity.User;
import com.bolg.model.vo.TeamUserVO;
import com.bolg.model.vo.TeamVO;
import com.bolg.service.TeamService;
...
public class TeamController {
    ...
    @Resource
    private com.bolg.service.UserTeamService UserTeamService;
     ...
     */
    @PostMapping("/add")
    @Limit(key = "limit1", permitsPerSecond = 1, timeout = 500, msg = "当前排队人数较多，请稍后再试！")
    ...
    public BaseResponse<Boolean> joinTeam(@RequestBody TeamJoinRequest teamJoinRequest, HttpServletRequest request){
        ...
        ThrowUtils.throwIf(loginUser == null,ErrorCode.NOT_LOGIN_ERROR);
        RLock lockJoin = redissonClient.getLock("LockJoin"+loginUser.getId());
        boolean isLock = lockJoin.tryLock();
        ThrowUtils.throwIf(!isLock,ErrorCode.OPERATION_ERROR);
